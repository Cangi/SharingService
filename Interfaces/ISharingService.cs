...
namespace SharingService
{
    ...
    /// </summary>
    public interface ISharingService : IService, ISharingServiceObjectInitializer
    {
         /// <summary>
        ...
        SharingServiceProfile defaultProfile { get; }

        SharingServiceProtocol Protocol { get; }
        ...
        /// </summary>
        SharingServiceAvatarSettings AvatarSettings { get; }
