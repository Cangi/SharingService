...
namespace SharingService.Avatars
{
    public class AvatarHandMovement : MonoBehaviour
    {
        ...
        public Transform GetTransform(XRHandJointID joint)
        {
        ...
        private void OnTransformsChanged(AvatarHandTransforms sender, IReadOnlyDictionary<XRHandJointID, Transform> transforms)
        {
            InitializeJoints();
        }
        ...
        private class AvatarJoint
        {
            ...
            private AvatarJoint(XRHandJointID joint, bool isSerialized, bool isHand, bool hasPose, Transform transform)
            {
                this.joint = joint;
                this.isHand = isHand;
