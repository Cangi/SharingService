...
namespace SharingService
{
    ...
    public class OfflineSpawner
    {
        ...
        public OfflineSpawner(ISharingService sharingService)
        {
        ...
        public Task<GameObject> SpawnTarget(GameObject original, object[] data)
        {
            ...
            if (sharingObjects != null)
            {
                ...
                {
                    sharingObject.Initialize(_sharingService.CreateTarget(sharingObject.Type, NextObjectId().ToString()));
                    var initializer = _sharingService as ISharingServiceObjectInitializer;
